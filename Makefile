...
CC = clang-23
CFLAGS = -Wall -O1 -Wextra -Wno-unused-parameter -Wno-unused-variable -Wno-missing-braces -fomit-frame-pointer -fzero-call-used-regs=skip  -Wno-unused-function -std=c11 -g -DCI_LEXER 
#-DBB_VM_DEBUG
