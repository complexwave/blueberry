...
#define CI_MAP          ((uint16_t)(CI_MAP_TAG | CI_REFCOUNTABLE))

#define CI_IS_ANY_MAP(ptr)  CI_CHECK_MASK_FAMILY(ptr, CI_MAP_FAMILY, CI_MAP_FAMILY)
#define CI_IS_MAP(ptr)      CI_CHECK_MASK_FAMILY(ptr, CI_MAP_TAG, CI_MAP_FAMILY)
